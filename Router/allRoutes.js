...
export const allRoutes = [
    ...
    new Route("/account", "Compte", "/pages/account.html", ["client", "admin"]),
    new Route("/editPassword", "Changement de mot de passe", "/pages/editPassword.html", ["client", "admin"]),
    new Route("/reservations", "Réservations", "/pages/reservations.html", ["client"]),
    new Route("/reserver", "Ma réservation", "/pages/reserver.html", ["client"])
];
